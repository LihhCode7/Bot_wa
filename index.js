/*
	...
	あ JASA RUN HEROKU BISA PC wa.me/6282155437473 BIAR BOT NYA GAK TERLALU DELAY
...
img = setting.img
baper = 'dinn_yourbee'
apiku = 'https://instagram.com/din_yourbee'
gc_wa_lu = 'https://chat.whatsapp.com/HyKhrXregwHBcYJw7ZUpbd' 
...
await alpha.updatePresence(from, Presence.composing)
		...
		try {
					...
					pp_userb = 'https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg'
				}
	...
	return admins
		...
		const alphaNumber = [`6282155437473@s.whatsapp.net`, `918156874290@s.whatsapp.net` , `62857101331033@s.whatsapp.net`]
...
const bugtrol = { 
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"message": `${creator}`,
						"orderTitle": `${creator}`,
						"sellerJid": "6282155437473@s.whatsapp.net",
						"token": "AR5b5YFz2g4W5fYrjbeakPiI3/XxarATSeP+KLh+0FGwkw=="
					}}}
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `dinn_yourbee\nBy ${ownername}`, orderTitle: 'din_yourbee', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`))  
let fil = vote.map(v => v.participant)
let id_vote = sender ? sender : '6282155437473@s.whatsapp.net'
if(fil.includes(id_vote)) {
...
let papako = [{
	...
	case 'test': case 'help':
			try {
				...
				chatt = 'https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg'
				}
...
break
		...
		var value = args.join(' ')
				...
				case 'belipremium': case 'buypremium': case 'sewabot': case 'goprem':
							let sewalak = await getBuffer('https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg')
				...
				case 'gcbot': case 'grupbot': case 'groupbot':
							let gcbot = await getBuffer('https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg')
							...
							break
				case 'infobot':
				let infobopot = await getBuffer('https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg')
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					try {
						...
						pic = 'https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg'
					}
					seeer = `Nama : *${pushname}`
		...
		var groupz = await alpha.chats.all().filter(v => v.jid.endsWith('g.us'))
			...
			case 'infogc':
					...
					ppimg = await alpha.getProfilePicture(from)
						...
						ppimg = 'https://i.ibb.co/qdwgbJP/IMG-20220114-WA0010.jpg'
					}
